...
import com.example.myapplication.CSS;
...
public class CSS_Adapter extends RecyclerView.Adapter<CSS_Adapter.ViewHolder> implements RecyclerViewClickListener {
    public int t;
    Context context;
...
public int Prodid=0;
    public CSS_Adapter(Context context, CSS recyclerViewOnItemClick1, ArrayList<Home_Model> home_models) {
